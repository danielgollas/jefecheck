...
#ifndef Fl_Spinner_gfc_H
#define Fl_Spinner_gfc_H
...
//
// Fl_Spinner_gfc widget class...
//

class Fl_Spinner_gfc : public Fl_Group
{
	...
	static void	sb_cb(Fl_Widget *w, Fl_Spinner_gfc *sb) {
		double v;		// New value
...
public:
	...
	Fl_Spinner_gfc(int X, int Y, int W, int H, const char *L = 0)
		: Fl_Group(X, Y, W, H, L),
		...
		H / 2 + 2, H / 2, "@-42>") {
			...
			input_.color(fl_rgb_color(GFC_WIDGET_COLOR,GFC_WIDGET_COLOR,GFC_WIDGET_COLOR));
			up_button_.box(FL_FLAT_BOX);
			up_button_.color(fl_rgb_color(GFC_WIDGET_COLOR,GFC_WIDGET_COLOR,GFC_WIDGET_COLOR));
			down_button_.box(FL_FLAT_BOX);
			down_button_.color(fl_rgb_color(GFC_WIDGET_COLOR,GFC_WIDGET_COLOR,GFC_WIDGET_COLOR));
