...
Fl_Double_Window* PreferencesWindow::make_window() {
  { preferencesWindow = new Fl_Double_Window(348, 590, "JefeCheck -Preferences");
    ...
    { tabs = new Fl_Tabs(0, 10, 355, 589);
      ...
      tabs->color(FL_FOREGROUND_COLOR);
      tabs->selection_color(FL_INACTIVE_COLOR);
      tabs->labelcolor((Fl_Color)31);
      ...
      { Fl_Group* o = new Fl_Group(0, 28, 352, 571, "General");
        ...
        { Fl_Group* o = new Fl_Group(10, 39, 320, 133, "Startup");
          ...
          { startFullscreenCheckBox = new Fl_Round_Button(20, 84, 15, 15, "Start in fullscreen mode");
            ...
            startFullscreenCheckBox->align(Fl_Align(FL_ALIGN_BOTTOM_LEFT|FL_ALIGN_INSIDE));
          ...
          { loadWindowOnStartupCheckBox = new Fl_Round_Button(20, 64, 15, 15, "Open Load window on startup");
            ...
            loadWindowOnStartupCheckBox->align(Fl_Align(FL_ALIGN_BOTTOM_LEFT|FL_ALIGN_INSIDE));
...
_DEFAULT_BROWSE_PATH");
            ...
            defaultBrowsePath->textcolor((Fl_Color)31);
            defaultBrowsePath->align(Fl_Align(FL_ALIGN_TOP_LEFT));
          ...
          { attemptToRecoverFromCrashCheckBox = new Fl_Round_Button(20, 105, 15, 15, "Attempt to recover from crash");
            ...
            attemptToRecoverFromCrashCheckBox->align(Fl_Align(FL_ALIGN_BOTTOM_LEFT|FL_ALIGN_INSIDE));
...
unction properly even when loading large sequences");
            ...
            percentageOfRam->textcolor((Fl_Color)31);
            percentageOfRam->callback((Fl_Callback*)PreferencesCB);
            percentageOfRam->align(Fl_Align(FL_ALIGN_TOP_LEFT));
            o->color(fl_rgb_color(GFC_WIDGET_COLOR,GFC_WIDGET_COLOR,GFC_WIDGET_COLOR));
            o->selection_color(fl_rgb_color(GFC_WIDGET_COLOR,GFC_WIDGET_COLOR,GFC_WIDGET_COLOR));
...
an your attempted frame rate.");
          ...
          { maximumFramesInQueue = new Fl_Value_Input(244, 337, 30, 15, "Max Frames in Queue");
            ...
            maximumFramesInQueue->textcolor((Fl_Color)31);
            maximumFramesInQueue->callback((Fl_Callback*)PreferencesCB);
            maximumFramesInQueue->align(Fl_Align(FL_ALIGN_TOP));
...
r and might fill up RAM before the same amount of DPXs are read");
 ...
 but takes longer to calculate.");
            ...
            histogramQuality->textcolor((Fl_Color)31);
            histogramQuality->callback((Fl_Callback*)PreferencesCB);
            histogramQuality->align(Fl_Align(FL_ALIGN_LEFT));
            o->color(fl_rgb_color(GFC_WIDGET_COLOR,GFC_WIDGET_COLOR,GFC_WIDGET_COLOR));
            o->selection_color(fl_rgb_color(GFC_WIDGET_COLOR,GFC_WIDGET_COLOR,GFC_WIDGET_COLOR));
...
ticularly DPX).");
            ...
            processorPriority->align(Fl_Align(FL_ALIGN_RIGHT));
        ...
        { Fl_Group* o = new Fl_Group(10, 238, 320, 49, "Text Display");
          ...
          { Fl_Value_Input* o = textDisplayFontSize = new Fl_Value_Input(80, 261, 25, 15, "Font Size");
            ...
            textDisplayFontSize->textcolor((Fl_Color)31);
          ...
          { Fl_Value_Input* o = textDisplayOpacity = new Fl_Value_Input(236, 262, 36, 15, "Opacity");
            ...
            textDisplayOpacity->textcolor((Fl_Color)31);
          ...
          { Fl_Value_Input* o = textDisplayColor = new Fl_Value_Input(148, 262, 34, 15, "Color");
            ...
            textDisplayColor->textcolor((Fl_Color)31);
        ...
        { Fl_Group* o = new Fl_Group(175, 179, 155, 53, "Action Feedback");
          ...
          { Fl_Value_Input* o = ActionFeedbackSize = new Fl_Value_Input(210, 210, 25, 15, "Size");
            ...
            ActionFeedbackSize->textcolor((Fl_Color)31);
...
y Off)");
            ...
            ActionFeedbackFadeDelay->textcolor((Fl_Color)31);
      ...
      { formatsTab = new Fl_Group(0, 30, 355, 479, "Formats");
        ...
        { Fl_Group* o = new Fl_Group(0, 33, 350, 264, "OpenEXR");
          o->box(FL_BORDER_FRAME);
          o->color(FL_INACTIVE_COLOR);
          o->labelfont(1);
          o->labelcolor((Fl_Color)31);
          o->align(Fl_Align(FL_ALIGN_TOP_LEFT|FL_ALIGN_INSIDE));
          { exrIgnoreDisplayWindow = new Fl_Check_Button(10, 59, 20, 15, "Ignore Display Window");
          ...
          { exrIgnoreHeadersAspectRatio = new Fl_Check_Button(10, 82, 20, 15, "Ignore Header\'s Aspect Ratio");
          ...
          { Fl_Group* o = new Fl_Group(9, 105, 331, 91, "Half > 8bit  transformation");
            o->box(FL_BORDER_FRAME);
            o->color(FL_INACTIVE_COLOR);
            o->labelfont(1);
            o->labelcolor((Fl_Color)31);
            o->align(Fl_Align(FL_ALIGN_TOP_LEFT|FL_ALIGN_INSIDE));
            { exrEnableExposureTransformOnLoad = new Fl_Check_Button(25, 128, 20, 15, "Enable Exposure Transform on Load");
...
n Integer buffer (8bpc, 16bpc, 4bpc, S3TC)");
            ...
            { Fl_Value_Input* o = exrExposure = new Fl_Value_Input(80, 149, 34, 15, "Exposure");
              ...
              exrExposure->textcolor((Fl_Color)31);
              exrExposure->callback((Fl_Callback*)PreferencesCB);
              o->color(fl_rgb_color(GFC_WIDGET_COLOR,GFC_WIDGET_COLOR,GFC_WIDGET_COLOR));
            } // Fl_Value_Input* exrExposure
            { Fl_Value_Input* o = exrDefog = new Fl_Value_Input(159, 149, 45, 15, "Defog");
              ...
              exrDefog->textcolor((Fl_Color)31);
              exrDefog->callback((Fl_Callback*)PreferencesCB);
              o->color(fl_rgb_color(GFC_WIDGET_COLOR,GFC_WIDGET_COLOR,GFC_WIDGET_COLOR));
            } // Fl_Value_Input* exrDefog
            { Fl_Value_Input* o = exrKneeLow = new Fl_Value_Input(80, 172, 34, 15, "Knee low");
              ...
              exrKneeLow->textcolor((Fl_Color)31);
              exrKneeLow->callback((Fl_Callback*)PreferencesCB);
              o->color(fl_rgb_color(GFC_WIDGET_COLOR,GFC_WIDGET_COLOR,GFC_WIDGET_COLOR));
            } // Fl_Value_Input* exrKneeLow
            { Fl_Value_Input* o = exrKneeHigh = new Fl_Value_Input(180, 172, 34, 15, "Knee high");
              ...
              exrKneeHigh->textcolor((Fl_Color)31);
              exrKneeHigh->callback((Fl_Callback*)PreferencesCB);
              o->color(fl_rgb_color(GFC_WIDGET_COLOR,GFC_WIDGET_COLOR,GFC_WIDGET_COLOR));
            } // Fl_Value_Input* exrKneeHigh
            { Fl_Value_Input* o = exrGamma = new Fl_Value_Input(255, 149, 34, 15, "Gamma");
              ...
              exrGamma->textcolor((Fl_Color)31);
              exrGamma->callback((Fl_Callback*)PreferencesCB);
              o->color(fl_rgb_color(GFC_WIDGET_COLOR,GFC_WIDGET_COLOR,GFC_WIDGET_COLOR));
            } // Fl_Value_Input* exrGamma
            { Fl_Button_gfc* o = new Fl_Button_gfc(230, 171, 60, 18, "Defaults");
              o->box(FL_FLAT_BOX);
              o->color(FL_INACTIVE_COLOR);
              o->selection_color(FL_BACKGROUND_COLOR);
              o->labeltype(FL_NORMAL_LABEL);
          ...
          { Fl_Group* o = new Fl_Group(9, 199, 331, 66, "Float > 8bit  transformation");
            o->box(FL_BORDER_FRAME);
            o->color(FL_INACTIVE_COLOR);
            o->labelfont(1);
            o->labelcolor((Fl_Color)31);
            o->align(Fl_Align(FL_ALIGN_TOP_LEFT|FL_ALIGN_INSIDE));
            { exrEnableRangeScaling = new Fl_Check_Button(25, 222, 20, 15, "Enable Range Scaling");
              exrEnableRangeScaling->tooltip("Perform the reference Float to Integer color transformation when loading to a\
n Integer buffer (8bpc, 16bpc, 4bpc, S3TC)");
              exrEnableRangeScaling->down_box(FL_FLAT_BOX);
              exrEnableRangeScaling->color(FL_INACTIVE_COLOR);
              exrEnableRangeScaling->selection_color((Fl_Color)31);
              exrEnableRangeScaling->labelcolor((Fl_Color)31);
              exrEnableRangeScaling->callback((Fl_Callback*)PreferencesCB);
            } // Fl_Check_Button* exrEnableRangeScaling
            { Fl_Value_Input* o = exrRangeMin = new Fl_Value_Input(63, 243, 90, 15, "min");
              exrRangeMin->tooltip("min value in the float range, this will map to 0. For example, for float Z-De\
pth passes the camera near-clip plane value would be appropriate.");
              exrRangeMin->box(FL_FLAT_BOX);
              exrRangeMin->color(FL_INACTIVE_COLOR);
              exrRangeMin->selection_color(FL_FOREGROUND_COLOR);
              exrRangeMin->labelsize(12);
              exrRangeMin->labelcolor((Fl_Color)31);
              exrRangeMin->minimum(-1e+008);
              exrRangeMin->maximum(1e+008);
              exrRangeMin->step(1e-007);
              exrRangeMin->textsize(12);
              exrRangeMin->textcolor((Fl_Color)31);
              exrRangeMin->callback((Fl_Callback*)PreferencesCB);
              o->color(fl_rgb_color(GFC_WIDGET_COLOR,GFC_WIDGET_COLOR,GFC_WIDGET_COLOR));
            } // Fl_Value_Input* exrRangeMin
            { Fl_Value_Input* o = exrRangeMax = new Fl_Value_Input(191, 243, 90, 15, "max");
              exrRangeMax->tooltip("max value in the float range, this will map to 255. For example, for float Z-\
Depth passes the camera far-clip plane value would be appropriate.");
              exrRangeMax->box(FL_FLAT_BOX);
              exrRangeMax->color(FL_INACTIVE_COLOR);
              exrRangeMax->selection_color(FL_FOREGROUND_COLOR);
              exrRangeMax->labelsize(12);
              exrRangeMax->labelcolor((Fl_Color)31);
              exrRangeMax->minimum(-1e-008);
              exrRangeMax->maximum(1e+008);
              exrRangeMax->step(1e-007);
              exrRangeMax->value(1000);
              exrRangeMax->textsize(12);
              exrRangeMax->textcolor((Fl_Color)31);
              exrRangeMax->callback((Fl_Callback*)PreferencesCB);
              o->color(fl_rgb_color(GFC_WIDGET_COLOR,GFC_WIDGET_COLOR,GFC_WIDGET_COLOR));
            } // Fl_Value_Input* exrRangeMax
            o->end();
          } // Fl_Group* o
          o->end();
        } // Fl_Group* o
      ...
      { remoteSessionTab = new Fl_Group(5, 30, 347, 426, "Remote");
        ...
        { Fl_Group* o = new Fl_Group(10, 44, 320, 72, "Chat Options");
          ...
          { Fl_Value_Input* o = fontSize = new Fl_Value_Input(80, 67, 25, 15, "Font Size");
            ...
            fontSize->textcolor((Fl_Color)31);
          ...
          { Fl_Value_Input* o = fadeDelay = new Fl_Value_Input(215, 90, 25, 15, "Delay");
            ...
            fadeDelay->textcolor((Fl_Color)31);
            fadeDelay->callback((Fl_Callback*)PreferencesCB);
            fadeDelay->align(Fl_Align(FL_ALIGN_RIGHT));
            o->color(fl_rgb_color(GFC_WIDGET_COLOR,GFC_WIDGET_COLOR,GFC_WIDGET_COLOR));
...
short delay if this is enabled.");
          ...
          { Fl_Value_Input* o = chatLines = new Fl_Value_Input(95, 90, 25, 15, "History Lines");
            ...
            chatLines->textcolor((Fl_Color)31);
        ...
        { Fl_Group* o = new Fl_Group(10, 120, 320, 72, "Remote Pointers Options");
          ...
          { Fl_Value_Input* o = remotePointerFontSize = new Fl_Value_Input(74, 143, 25, 15, "Font Size");
            ...
            remotePointerFontSize->textcolor((Fl_Color)31);
          ...
          { Fl_Value_Input* o = remotePointerFadeDelay = new Fl_Value_Input(261, 144, 25, 15, "Delay");
            ...
            remotePointerFadeDelay->textcolor((Fl_Color)31);
            remotePointerFadeDelay->callback((Fl_Callback*)PreferencesCB);
            remotePointerFadeDelay->align(Fl_Align(FL_ALIGN_RIGHT));
            o->color(fl_rgb_color(GFC_WIDGET_COLOR,GFC_WIDGET_COLOR,GFC_WIDGET_COLOR));
          ...
          { Fl_Value_Input* o = remotePointerTrailLenght = new Fl_Value_Input(140, 167, 35, 15, "Trail Lenght");
            ...
            remotePointerTrailLenght->textcolor((Fl_Color)31);
...
short delay if this is enabled.");
          ...
          { Fl_Value_Input* o = remotePointerSize = new Fl_Value_Input(177, 144, 25, 15, "Pointer Size");
            ...
            remotePointerSize->textcolor((Fl_Color)31);
...
short delay if this is enabled.");
          ...
          { Fl_Spinner_gfc* o = remotePointerColor = new Fl_Spinner_gfc(220, 167, 29, 18, "Color");
            ...
            remotePointerColor->align(Fl_Align(FL_ALIGN_LEFT));
        ...
        { Fl_Group* o = new Fl_Group(10, 274, 320, 72, "Update Frequency (per second)");
          ...
          { Fl_Value_Input* o = remoteTransformationsFrequency = new Fl_Value_Input(110, 301, 25, 15, "Transformations");
            ...
            remoteTransformationsFrequency->textcolor((Fl_Color)31);
          ...
          { Fl_Value_Input* o = remoteFXFrequency = new Fl_Value_Input(110, 321, 25, 15, "FX Parameters");
            ...
            remoteFXFrequency->textcolor((Fl_Color)31);
          ...
          { Fl_Value_Input* o = remoteOthersFrequency = new Fl_Value_Input(245, 302, 25, 15, "Others Messages");
            ...
            remoteOthersFrequency->textcolor((Fl_Color)31);
      ...
      { pathsTab = new Fl_Group(5, 40, 347, 464, "Paths");
        ...
        { Fl_Group* o = new Fl_Group(10, 40, 325, 241, "Sequence Search Paths");
          ...
          { Fl_Browser* o = searchPaths = new Fl_Browser(20, 128, 305, 119);
            ...
            searchPaths->textcolor((Fl_Color)31);
          ...
          { searchPathBrowse = new Fl_Button_gfc(22, 102, 64, 20, "Browse");
            ...
            searchPathBrowse->align(Fl_Align(FL_ALIGN_CENTER));
          ...
          { searchPathDelete = new Fl_Button_gfc(285, 249, 39, 20, "@9+");
            ...
            searchPathDelete->align(Fl_Align(FL_ALIGN_CENTER));
...
hare sessions across computers with different filesystem structures.");
      ...
      { licensingTab = new Fl_Group(5, 35, 347, 459, "License");
        licensingTab->color(FL_FOREGROUND_COLOR);
        licensingTab->selection_color(FL_FOREGROUND_COLOR);
        licensingTab->labelcolor(FL_INACTIVE_COLOR);
        licensingTab->hide();
        { licenseFileGroup = new Fl_Group(10, 35, 320, 116, "License File");
          licenseFileGroup->box(FL_BORDER_FRAME);
          licenseFileGroup->color(FL_INACTIVE_COLOR);
          licenseFileGroup->labelfont(1);
          licenseFileGroup->labelcolor((Fl_Color)31);
          licenseFileGroup->align(Fl_Align(FL_ALIGN_TOP_LEFT|FL_ALIGN_INSIDE));
          { Fl_Input* o = licenseFilePath = new Fl_Input(15, 76, 234, 18, "License File Path");
            licenseFilePath->box(FL_FLAT_BOX);
            licenseFilePath->color(FL_INACTIVE_COLOR);
            licenseFilePath->labelcolor((Fl_Color)31);
            licenseFilePath->textcolor((Fl_Color)31);
            licenseFilePath->align(Fl_Align(FL_ALIGN_TOP_LEFT));
            licenseFilePath->when(FL_WHEN_CHANGED);
            o->color(fl_rgb_color(GFC_WIDGET_COLOR,GFC_WIDGET_COLOR,GFC_WIDGET_COLOR));
          } // Fl_Input* licenseFilePath
          { Fl_Button_gfc* o = new Fl_Button_gfc(253, 76, 68, 18, "browse");
            o->box(FL_FLAT_BOX);
            o->color(FL_INACTIVE_COLOR);
            o->selection_color(FL_BACKGROUND_COLOR);
            o->labeltype(FL_NORMAL_LABEL);
            ...
            o->labelsize(14);
            o->labelcolor((Fl_Color)31);
            o->callback((Fl_Callback*)PreferencesCB, (void*)(LICENSEPATHBROWSEBUTTON_ID));
            o->align(Fl_Align(FL_ALIGN_CENTER));
            o->when(FL_WHEN_RELEASE);
          } // Fl_Button_gfc* o
          { Fl_Button_gfc* o = new Fl_Button_gfc(15, 101, 215, 31, "Request a new License");
            o->tooltip("Request a new license to use JefeCheck on this machine.");
            o->box(FL_FLAT_BOX);
            o->color(FL_INACTIVE_COLOR);
            o->selection_color(FL_BACKGROUND_COLOR);
            o->labeltype(FL_NORMAL_LABEL);
            ...
            o->labelsize(14);
            o->labelcolor((Fl_Color)31);
            o->callback((Fl_Callback*)PreferencesCB, (void*)(LICENSEREQUESTNEWLICENSEEBUTTON_ID));
            o->align(Fl_Align(FL_ALIGN_CENTER));
            o->when(FL_WHEN_RELEASE);
          } // Fl_Button_gfc* o
          licenseFileGroup->end();
        } // Fl_Group* licenseFileGroup
        { Fl_Group* o = new Fl_Group(10, 214, 320, 75, "License Server");
          o->box(FL_BORDER_FRAME);
          o->color(FL_INACTIVE_COLOR);
          o->labelfont(1);
          ...
          o->hide();
          o->deactivate();
          { licenseServerIP = new Fl_Input(15, 256, 205, 18, "Server IP");
            licenseServerIP->tooltip("When browsing for sequences, this will be the default folder the browser open\
s. Set it to point to the project folder you are currently working on to make \
browsing easier!");
            licenseServerIP->labelcolor(FL_BACKGROUND2_COLOR);
            licenseServerIP->align(Fl_Align(FL_ALIGN_TOP_LEFT));
            licenseServerIP->when(FL_WHEN_CHANGED);
          } // Fl_Input* licenseServerIP
          { licenseServerPort = new Fl_Input(228, 256, 85, 18, "Port");
            licenseServerPort->tooltip("When browsing for sequences, this will be the default folder the browser open\
s. Set it to point to the project folder you are currently working on to make \
browsing easier!");
            licenseServerPort->labelcolor(FL_BACKGROUND2_COLOR);
            licenseServerPort->align(Fl_Align(FL_ALIGN_TOP_LEFT));
            licenseServerPort->when(FL_WHEN_CHANGED);
