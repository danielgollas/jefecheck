...
gfcImageLoaderEXR2::gfcImageLoaderEXR2()
        : gfcImageLoader() {
    theBitmap=NULL;
...
int gfcImageLoaderEXR2::fillProcessor ( gfcImageProcessor& processor ) {
    return 0;
}


/*
void gfcImageLoaderEXR2::copyPixelsToDisplayWindow(int startX, int startY, int copyWidth, int copyHeigth, int preLineOffset, int postLineOffset)
{
...
/*
void gfcImageLoaderEXR2::copyHalfPixelsToDisplayWindow(int startX, int startY, int copyWidth, int copyHeigth, int preLineOffset, int postLineOffset)
{
...
/*
void gfcImageLoaderEXR2::copyFloatPixelsToDisplayWindow(int startX, int startY, int copyWidth, int copyHeigth, int preLineOffset, int postLineOffset)
{
...
int gfcImageLoaderEXR2::layerHasRGBA(Imf::ChannelList::ConstIterator start, Imf::ChannelList::ConstIterator end)
{
		return 0;
}
...
std::vector<std::string> gfcImageLoaderEXR2::getChannelsInLayer(const ChannelList &channels, std::string layerName)
{
...
int gfcImageLoaderEXR2::loadChannelNames(){
...
int gfcImageLoaderEXR2::load ( gfcLoadParams params ) {
    using namespace Imath;
    using namespace Imf;
	...
	try{
			file= new Imf::InputFile(params.fileName.c_str());
			//get the channel names
			if(loadChannelNames()==1){
				return 1;
			}
			//Validate channelNames and selected channel
...
int gfcImageLoaderEXR2::peek ( gfcLoadParams params, gfcPeekInfo* results ) {
    return 0;
}
...
std::vector< std::string > gfcImageLoaderEXR2::getChannelNames() {
    return channelNames;
}

void gfcImageLoaderEXR2::releaseMemory() {
    if (theBitmap)
...
void gfcImageLoaderEXR2::readMetaData(const Imf::Header & header)
{
	using namespace Imf;
	std::stringstream ss;
